...
/**
 * optional uint32 min_input_confs = 4;
 * @return {number}
 */
 ...
 */
  proto.services.GetDiscussionHistoryByIDRequest.toObject = function(includeInstance, msg) {
    var f, obj = {
      id: jspb.Message.getFieldWithDefault(msg, 1, 0),
      pageOptions: (f = msg.getPageOptions()) && proto.services.PageOptions.toObject(includeInstance, f)
    };
...
proto.services.GetDiscussionHistoryByIDRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 1:
      ...
      break;
    case 2:
      var value = new proto.services.PageOptions;
      reader.readMessage(value,proto.services.PageOptions.deserializeBinaryFromReader);
...
proto.services.GetDiscussionHistoryByIDRequest.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      2,
      f,
      proto.services.PageOptions.serializeBinaryToWriter
    );
  }
};
...
/**
 * optional PageOptions page_options = 2;
 * @return {?proto.services.PageOptions}
 */
proto.services.GetDiscussionHistoryByIDRequest.prototype.getPageOptions = function() {
  return /** @type{?proto.services.PageOptions} */ (
    jspb.Message.getWrapperField(this, proto.services.PageOptions, 2));
};


/** @param {?proto.services.PageOptions|undefined} value */
